...
$consulta="SELECT * FROM silo order by id_fsilo Desc";
...
<body>
	<div id="cuerpo">
		<div id="contenido">
		<h3 align="center">Historial Silos</h3>
           	<br />
        	...
        	<table id="Resultados" border="1" align="center">
                <tbody>	
					...
					<td><?php $consulta2 = "SELECT * FROM `usuario` WHERE num_ficha = '".$comp["ficha"]."'";
											$comprobar2 = mysqli_query($con, $consulta2) or die ("Error en $consulta2 <br> MySQL dice: ".mysql_error());
