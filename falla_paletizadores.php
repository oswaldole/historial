...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_paletizadores.php" method="GET">
				<fieldset>
				<legend>Reporte De Paletizadores</legend>
							...
							<label for="paletizador">Paletizador</label>
							<select class="k-ComboBox" name="paletizador" id="paletizador" size="1" >
								<option value="0" selected="selected">Escoge</option>
