...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_tratamientos.php" method="GET">
				<fieldset>
				<legend>Reporte De Tratamientos</legend>
							...
							<select class="k-ComboBox" name="tratamientos" id="tratamientos" size="1" >
								<option value="0" selected="selected">Escoge</option>
