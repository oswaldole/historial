...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_archas.php" method="GET">
				<fieldset>
				<legend>Reporte archas</legend>
							...
							<br />
							<label for="cuarto">Archas</label>
							<select class="k-ComboBox" name="cuarto" id="aguadet" size="1" >
								<option value="0" selected="selected">Escoge</option>
