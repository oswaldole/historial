...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_maquinasdeco.php" method="GET">
				<fieldset>
				<legend>Reporte De Maquina de Decoracion</legend>
							...
							<label for="maquinasdeco">Maquina de Decoracion</label>
							<select class="k-ComboBox" name="maquinasdeco" id="maquinasdeco" size="1" >
								<option value="0" selected="selected">Escoge</option>
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
