...
$("#turno").kendoComboBox();
$("#grupo").kendoComboBox();
$("#despaletizadores").kendoComboBox();
$("#inicio_f").kendoDateTimePicker({format: "dd/MM/yyyy hh:mm tt"});
$("#final_f").kendoDateTimePicker({format: "dd/MM/yyyy hh:mm tt"});
fecha ();
check ();
...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_despaletizadores.php" method="GET">
				<fieldset>
				<legend>Reporte De Despaletizadores</legend>
							...
							<label for="despaletizadores">Despaletizador</label>
							<select class="k-ComboBox" name="despaletizadores" id="despaletizadores" size="1" >
								<option value="0" selected="selected">Escoge</option>
								<option value="1">1</option>
								<option value="2">2</option>
                              	<option value="Z">Z</option>
							...
							<input class="" type="checkbox" tabindex="4" id="produccion">
							<br />
							<br />
