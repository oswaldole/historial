...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_transportadores.php" method="GET">
				<fieldset>
					<legend>Reporte Transportadores</legend>
					...
					<select class="k-ComboBox" name="transportador" id="transportador" size="1" >
						<option value="0" selected="selected">Escoge</option>
						<option value="1">Linea1</option>
						<option value="2">Linea2</option>
