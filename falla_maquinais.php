...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_maquinais.php" method="GET">
				<fieldset>
				<legend>Reporte De Falla de Maquinas IS</legend>
							...
							<label for="maquinais">Maquina</label>
							<select class="k-ComboBox" name="maquinais" id="maquinais" size="1" >
								<option value="0" selected="selected">Escoge</option>
