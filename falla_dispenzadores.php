...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_dispenzadores.php" method="GET">
				<fieldset>
					<legend>Reporte Dispenzadores</legend>
					...
					<select class="k-ComboBox" name="maquina" id="maquina" size="1" >
						...
						<option value="B">B</option>
						<option value="C">C</option>
						<option value="D">Decoracion</option>
						<option value="E">Carro Volador</option>
