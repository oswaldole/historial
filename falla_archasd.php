...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_archasd.php" method="GET">
				<fieldset>
				<legend>Reporte De Falla de Archas Decoracion</legend>
							...
							<label for="archadeco">Archa</label>
							<select class="k-ComboBox" name="archadeco" id="archadeco" size="1" >
								<option value="0" selected="selected">Escoge</option>
								<option value="A">A</option>
								<option value="B">B</option>
								<option value="C">C</option>
