<?php 
	...
	$consulta="SELECT * FROM despaletizadores order by id_fdespaletizador Desc";
...
<body>
	<div id="cuerpo">
		<div id="contenido">
		<h3 align="center">Historial Despaletizador</h3>
           	<br />
        	...
        	<table id="Resultados" border="1" align="center">
                <tbody>	
					...
					<td><?php $consulta2 = "SELECT * FROM `usuario` WHERE num_ficha = '".$comp["ficha"]."'";
						...
						<td><?php echo $comp["despaletizador"] ?></td>
