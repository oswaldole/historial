...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_alimentadores.php" method="GET">
				<fieldset>
				<legend>Reporte De Falla de Alimentadores</legend>
							...
							<select class="k-ComboBox" name="alimentador" id="alimentador" size="1" >
								<option value="0" selected="selected">Escoge</option>
