  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Chiller</li>
      </ol>
      <div class="row">
        <div class="col-lg-12">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-clock-o"> Reporte Rutinario Sistema Chiller</i>
            </div>
            <div class="card-body text-center">
              <form class="form-horizontal" id="rutina_agua">
                ...
                <div class="row mb-3">
                  ...
                  <label class="control-label col-sm-2" for="maquina">Maquina</label>
                  <div class="col-sm-4">
                ...
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="temperatura">Temperatura (°C)</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="temperatura" type="input" name="temperatura">
                  </div>
