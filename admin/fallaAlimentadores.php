  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Alimentadores</li>
      </ol>
      <div class="row">
        <div class="col-lg-12">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-fire"> Falla Alimentadores</i>
            </div>
            <div class="card-body text-center">
              <form class="form-horizontal" id="rutina_agua">
                ...
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="alimentadores">Alimentadores</label>
                  <div class="col-sm-4">
                    <select class="form-control" id="alimentadores" name="alimentadores">
                      <option value="0" selected>Seleccione</option>
