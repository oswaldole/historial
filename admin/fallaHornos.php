  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="#">Falla Zona Caliente</a>
        </li>
        <li class="breadcrumb-item active">Hornos</li>
      </ol>
      <div class="row">
        <div class="col-lg-12">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-fire"> Falla Hornos</i>
            </div>
            <div class="card-body text-center">
              <form class="form-horizontal" id="rutina_agua">
                ...
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="hornos">Horno</label>
                  <div class="col-sm-4">
                    <select class="form-control" id="hornos" name="hornos">
                      <option value="0" selected>Seleccione</option>
                      <option value="Horno A">Horno A</option>
                      <option value="Horno B">Horno B</option>
                      <option value="Horno C">Horno C</option>
                      <option value="Horno D">Horno D </option>
                      <option value="Horno E">Horno E</option>
                      <option value="Horno F">Horno F </option>
                    </select>
                  </div>
                </div>
                <div class="row mb-3">
