  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Trabajos de Taller </li>
      </ol>
      <div class="row">
        <div class="col-lg-12">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-wrench"> Trabajos en el taller</i>
            </div>
            <div class="card-body text-center">
              <form class="form-horizontal" id="rutina_agua">
                ...
                <div class="row mb-3">
                  <label for="comentario">Actividades Realizadas:</label>
                  <textarea class="form-control" id="Actividades" name="comentario" rows="5"></textarea>
                </div>
                <div class="row mb-3">
