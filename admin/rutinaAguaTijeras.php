  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Agua de Tijeras</li>
      </ol>
      <div class="row">
        <div class="col-lg-12">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-clock-o"> Reporte Rutinario de Agua de Tijeras</i>
            </div>
            <div class="card-body text-center">
              <form class="form-horizontal" id="rutina_agua">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control" id="cuarto" name="cuarto">
                      <option value="0" selected>Seleccione</option>
                ...
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="bomba">Bomba</label>
                  <div class="col-sm-4">
                    <select class="form-control" id="bomba" name="bomba">
                      <option value="0" selected>Seleccione</option>
                      <option value="1">1</option>
                      <option value="2">2</option>
                      <option value="3">3</option>
                  ...
                  <label class="control-label col-sm-2" for="lec_inicial">Lectura Inicial</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="lec_inicial" type="input" name="lec_inicial">
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="lec_final">Lectura Final</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="lec_final" type="input" name="lec_final">
                  </div>
                  <label class="control-label col-sm-2" for="biosol">Biosol</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="biosol" type="input" name="biosol">
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="c_agua">Litros de Agua</label>
                  <div class="col-sm-4">
                    <input class="form-control" id="c_agua" type="input" name="c_agua" disabled>
                  </div>
                  <label class="control-label col-sm-2" for="ratio">Ratio</label>
                  <div class="col-sm-4">
                    <input class="form-control" id="ratio" type="input" name="ratio" disabled>
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="p_suministro">Presion Suministro</label>
                  <div class="col-sm-4">
                    <input class="form-control" id="p_suministro" type="input">
                  </div>
                  <label class="control-label col-sm-2" for="p_salida">Presion Salida</label>
                  <div class="col-sm-4">
                    <input class="form-control" id="p_salida" type="input">
                  </div>
                </div>
                <div class="row mb-3">
    ...
    <script src="js/sb-aguaTijeras.min.js"></script>
  </div>
</body>
