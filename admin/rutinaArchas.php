  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Archas</li>
      </ol>
      <div class="row">
        <div class="col-lg-12">
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-clock-o"> Reporte Rutinario de Archas</i>
            </div>
            <div class="card-body text-center">
              <form class="form-horizontal" id="rutina_agua">
                ...
                <div class="row mb-3">
                  ...
                  <label class="control-label col-sm-2" for="archa">Archa</label>
                  <div class="col-sm-4">
                    <select class="form-control" id="archa" name="archa">
                      <option value="0" selected>Seleccione</option>
                      ...
                      <option value="Decoracion A">Decoracion A</option>
                      <option value="Decoracion B">Decoracion B</option>
                      <option value="Decoracion C">Decoracion C </option>
                    </select>
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="velocidadMalla">Velocidad de Malla</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="velocidadMalla" type="input" name="velocidadMalla">
                  </div>
                  <label class="control-label col-sm-2" for="molde">Molde</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="molde" type="input" name="molde">
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="control-label col-sm-2" for="velocidadMaquina">Velocidad Maquina</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="velocidadMaquina" type="input" name="velocidadMaquina">
                  </div>
                  <label class="control-label col-sm-2" for="temple">Temple</label>
                  <div class="col-sm-4">
                    <input class="form-control calculo" id="temple" type="input" name="temple">
                  </div>
                </div>
                <div class="row mb-3">
