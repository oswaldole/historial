...
<body>
	<div id="cuerpo">
		<div id="contenido">
            <form name="form" action="insertar_hornospre.php" method="GET">
				<fieldset>
				<legend>Reporte De Falla Horno de Precalentamiento</legend>
							...
							<select class="k-ComboBox" name="horno" id="horno" size="1" >
								<option value="0" selected="selected">Escoge</option>
