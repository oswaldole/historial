<?php 
	...
	$consulta="SELECT * FROM archas order by id_farcha Desc";
...
<body>
	<div id="cuerpo">
		<div id="contenido">
		<h3 align="center">Historial Archas</h3>
           	<br />
			<?php while ($comp = mysqli_fetch_array($con, $comprobar) ){ ?>
